//projet arduino : Gate Guru automatic barrier
...
/* Keeping the green LED on for 5 seconds */
    delay(5000);  
    ...
    digitalWrite(RED_ledPin, LOW);
     analogWrite(buzz_Pin, 1000);
    // Keeping the red LED and buzzer on for 5 seconds
    delay(2000);  
